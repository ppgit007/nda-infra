...
# Redis
module "redis" {
  for_each            = local.module_enabled.redis ? { enabled = true } : {}
...
# Azure AI Search
module "ai_search" {
  for_each            = local.module_enabled.ai_search ? { enabled = true } : {}
...
# Azure OpenAI
module "azure_openai" {
  for_each              = local.module_enabled.azure_openai ? { enabled = true } : {}
